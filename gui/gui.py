...
class Ui_MainWindow(object):
    ...
    def start_button_clicked(self):
        ...
        if not self.recording: 
            ...
            topics = '/rosout /subtask_topic /tf /vive/my_rudder_Pose /vive/my_left_controller_1_Pose /vive/my_left_controller_1/joy /vive/my_hmd_Pose /tf_static /joint_states /head_controller/command /clock /arm_left_controller/command'
